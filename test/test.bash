...
(sleep 1; echo "taste") | PYTHONUNBUFFERED=1 ros2 run pkg_kadai player1 > /tmp/pkg_kadai.log 2>&1
sleep 2
(sleep 1; echo "test") | PYTHONUNBUFFERED=1 ros2 run pkg_kadai2 player2 > /tmp/pkg_kadai2.log 2>&1
(sleep 1; echo "torst") | PYTHONUNBUFFERED=1 ros2 run pkg_kadai3 player3 > /tmp/pkg_kadai3.log 2>&1
sleep 1
