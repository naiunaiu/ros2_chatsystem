...
ros2 run pkg_kadai player1 > /tmp/pkg_kadai.log 2>&1 &
sleep 1
cat /tmp/pkg_kadai.log | grep 'No connection with partner' || ng "$LINENO"
(sleep 2; echo "taste") | ros2 run pkg_kadai player1 > /tmp/pkg_kadai.log 2>&1 &
(sleep 2; echo "test") | ros2 run pkg_kadai2 player2 >> /tmp/pkg_kadai2.log 2>&1 &
(sleep 2; echo "torst") | ros2 run pkg_kadai3 player3 >> /tmp/pkg_kadai3.log 2>&1 &
sleep 2
